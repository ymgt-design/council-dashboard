...
# テーマ順とカラー
THEME_ORDER = [
    "子育て・教育","行財政・行政運営","福祉・健康・医療","交通・公共交通","農林業",
...
/* Session timeline */
.tl{display:flex;align-items:flex-end;gap:10px;height:170px;padding:6px 0 0}
.tlcol{flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;min-width:0}
...
.tlcap{font-size:10.5px;color:var(--ink-2);text-align:center;line-height:1.25;font-weight:600}
...
<section class="view active" id="overview" role="tabpanel" aria-labelledby="tab-overview">
  ...
  <div class="grid2" style="margin-top:22px">
    ...
    <div class="card">
      <h2 class="sec" style="margin-top:0">定例会ごとの質問数</h2>
      <div class="tl" id="sessionTL"></div>
      <p class="lead" style="margin:14px 0 0;font-size:12px">斜線部分は「議会だより未掲載」の質問数（3問以上で〇のつかなかったもの）。</p>
    </div>
  </div>
...
function renderMatrix(){
  const TLABEL={'子育て・教育':'子育て・<br>教育','行財政・行政運営':'行財政・<br>行政運営','福祉・健康・医療':'福祉・健康・<br>医療','交通・公共交通':'交通・<br>公共交通','農林業':'農林業','防災・安全':'防災・<br>安全','自治・住民参画':'自治・<br>住民参画','まちづくり・公園・空き家':'まちづくり・<br>公園・空き家','産業・観光・文化財':'産業・観光・<br>文化財','人口・移住定住':'人口・<br>移住定住','環境':'環境'};
